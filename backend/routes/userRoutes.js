...
import { authUser, registerUser, getUserProfile, createAdminUser } from "../controllers/authController.js"
...
router.post("/create-admin", createAdminUser) // Add this route for creating admin
