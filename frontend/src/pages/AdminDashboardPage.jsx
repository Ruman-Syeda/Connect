...
const AdminDashboardPage = () => {
  ...
  const { loading: statsLoading, error: statsError, stats } = adminState
  const { loading: usersLoading, error: usersError, users, success } = adminState
  const analyticsState = useSelector((state) => state.analytics) || {}
  const { platformOverview, userAnalytics, loading: analyticsLoading, error: analyticsError } = analyticsState
