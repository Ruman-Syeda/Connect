...
const EventCreatePage = () => {
  ...
  const { loading, error, success, event } = useSelector((state) => state.events)
        ...
        <form onSubmit={submitHandler} className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              {image && (
                <div className="mt-2">
                  <img src={image || "/placeholder.svg"} alt="Event preview" className="h-32 object-cover rounded-md" />
                </div>
              )}
            </div>
