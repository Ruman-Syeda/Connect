        ...
        <div>
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6">
            ...
            <div className="p-6">
              ...
              {activeTab === "managers" && (
                <div>
                  <h2 className="text-xl font-semibold mb-4">Event Managers</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {/* Event Creator */}
                    <div className="flex items-center p-4 bg-green-50 rounded-md border border-green-100">
                      ...
                      <div>
                        <p className="font-medium text-lg">{event.creator?.name}</p>
                    ...
                    {/* Admin note */}
                    <div className="md:col-span-2 mt-4 p-4 bg-gray-50 rounded-md">
                      <p className="text-gray-600">
                        <span className="font-medium">Note:</span> Platform administrators also have full management
