...
// Alias for getCommunities for backward compatibility
export const getAllCommunities = getCommunities
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(updateCommunity.fulfilled, (state, action) => {
        ...
        state.community = action.payload
        state.success = true
        state.message = "Community updated successfully"
        state.error = null
      })
